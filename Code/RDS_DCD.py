...
def RDS_DCD(taskMap,workflowMap,vm_data,avg_compute_pow=40,res_prb=0.7):
    ...
    return "R+D+S_DCD" + str(res_prb) ,str(R_D_S_Stats.reserve_cost),str(R_D_S_Stats.ondemand_cost),str(R_D_S_Stats.total_spot_cost),str(total_cost),str(R_D_S_Stats.total_reward),str(R_D_S_Stats.total_reward-total_cost),total_deadlines_missed
